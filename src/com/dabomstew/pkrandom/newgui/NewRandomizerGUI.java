...
public class NewRandomizerGUI {
    ...
    private final int TRAINER_UNCHANGED = 0, TRAINER_RANDOM = 1, TRAINER_RANDOM_EVEN = 2, TRAINER_RANDOM_EVEN_MAIN = 3,
                        TRAINER_TYPE_THEMED = 4, TRAINER_TYPE_THEMED_ELITE4_GYMS = 5, TRAINER_TYPE_THEMED_ALL_GROUPS = 6;
...
//                conn.disconnect();
        ...
        wpThematicRadioButton.addActionListener(e -> enableOrDisableSubControls());
            ...
            if (gld.pressedOK()) {
                ...
                if (currentRestrictions != null && !currentRestrictions.allowTrainerSwapMegaEvolvables(
                        romHandler.forceSwapStaticMegaEvos(), isTrainerSetting(TRAINER_TYPE_THEMED) ||
                                isTrainerSetting(TRAINER_TYPE_THEMED_ELITE4_GYMS) || isTrainerSetting(TRAINER_TYPE_THEMED_ALL_GROUPS))) {
        ...
        tpBetterMovesetsCheckBox.addActionListener(e -> enableOrDisableSubControls());
        tpMovesetMinLevelCheckBox.addActionListener(e -> enableOrDisableSubControls());
    ...
    private void restoreStateFromSettings(Settings settings) {
        ...
        tpMovesetMinLevelCheckBox.setSelected(settings.isBetterTrainerMovesets() && settings.getBetterMovesetsMinLevel() > 0);
        tpMovesetMinLevelSpinner.setValue(settings.isBetterTrainerMovesets() ? settings.getBetterMovesetsMinLevel() : 0);
        ...
        wpThematicRadioButton.setSelected(settings.getWildPokemonMod() == Settings.WildPokemonMod.VANILLA_THEMED);
        ...
        wpNoWildStaticPokemonCheckBox.setSelected(settings.isNoWildStaticPokemon());
    ...
    private Settings createSettingsFromState(CustomNamesSet customNames) {
        ...
        settings.setTrainersMod(isTrainerSetting(TRAINER_UNCHANGED), isTrainerSetting(TRAINER_RANDOM),
                ...
                isTrainerSetting(TRAINER_TYPE_THEMED_ALL_GROUPS));
        ...
        settings.setBetterMovesetsMinLevel(tpBetterMovesetsCheckBox.isVisible() && tpBetterMovesetsCheckBox.isSelected() ? (int)tpMovesetMinLevelSpinner.getValue() : 0);
        ...
        settings.setWildPokemonMod(wpUnchangedRadioButton.isSelected(), wpRandomRadioButton.isSelected(), wpArea1To1RadioButton.isSelected(),
                wpGlobal1To1RadioButton.isSelected(), wpThematicRadioButton.isSelected());
        ...
        settings.setNoWildStaticPokemon(wpNoWildStaticPokemonCheckBox.isSelected() && wpNoWildStaticPokemonCheckBox.isVisible());
    ...
    private void initialState() {
        ...
        tpMovesetMinLevelSpinner.setVisible(false);
        tpMovesetMinLevelSpinner.setEnabled(false);
        tpMovesetMinLevelSpinner.setValue(0);
        tpMovesetMinLevelCheckBox.setVisible(false);
        tpMovesetMinLevelCheckBox.setEnabled(false);
        tpMovesetMinLevelCheckBox.setSelected(false);
        ...
        wpThematicRadioButton.setVisible(true);
        wpThematicRadioButton.setEnabled(false);
        wpThematicRadioButton.setSelected(false);
        ...
        wpNoWildStaticPokemonCheckBox.setVisible(true);
        wpNoWildStaticPokemonCheckBox.setEnabled(false);
        wpNoWildStaticPokemonCheckBox.setSelected(false);
    ...
    private void romLoaded() {
        ...
        try {
            ...
            wpThematicRadioButton.setEnabled(true);
    ...
    private void enableOrDisableSubControls() {
        ...
        if (wpRandomRadioButton.isSelected()) {
            ...
            wpARTypeThemeAreasRadioButton.setEnabled(false);
            wpBalanceShakingGrassPokemonCheckBox.setEnabled(false);
        } else if(wpThematicRadioButton.isSelected()) {
            wpARNoneRadioButton.setEnabled(false);
            wpARSimilarStrengthRadioButton.setEnabled(false);
            wpARCatchEmAllModeRadioButton.setEnabled(false);
            wpARTypeThemeAreasRadioButton.setEnabled(false);
        ...
        if (wpUnchangedRadioButton.isSelected()) {
            ...
            wpNoWildStaticPokemonCheckBox.setEnabled(true);
        }
        ...
        if(tpBetterMovesetsCheckBox.isVisible() && tpBetterMovesetsCheckBox.isSelected()) {
            tpMovesetMinLevelCheckBox.setVisible(true);
            tpMovesetMinLevelCheckBox.setEnabled(true);
            tpMovesetMinLevelSpinner.setVisible(true);
        }
        else {
            tpMovesetMinLevelCheckBox.setVisible(false);
            tpMovesetMinLevelCheckBox.setEnabled(false);
        ...
        if(tpMovesetMinLevelCheckBox.isVisible() && tpMovesetMinLevelCheckBox.isSelected()) {
            tpMovesetMinLevelSpinner.setEnabled(true);
        }
        else{
            tpMovesetMinLevelSpinner.setEnabled(false);
            tpMovesetMinLevelSpinner.setValue(0);
