...
public class MoveRandomizer {
    ...
    public MoveRandomizer(Random random, Settings settings, RomHandler romHandler, PokemonService pokemonService) {
        this.random = random;
    ...
    public void randomizeMovesLearnt() {
        ...
        for (Integer pkmnNum : movesets.keySet()) {
            ...
            Pokemon pkmn = pokemonService.findPokemonInPoolWithSpeciesID(pokemonService.getMainPokemonListInclFormes(), pkmnNum);
            if (pkmn == null) {
                continue;
            }
    ...
    public void metronomeOnlyMode() {
        ...
        romHandler.setTrainers(trainers, false);
    ...
    private void createSetsOfMoves(boolean noBroken, List<Move> validMoves, List<Move> validDamagingMoves,
        ...
        List<Integer> hms = romHandler.getHMMoves();
        Set<Integer> allBanned = new HashSet<Integer>(noBroken ? romHandler.getGameBreakingMoves() : Collections.EMPTY_SET);
